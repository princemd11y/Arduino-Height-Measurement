...
void loop() {
  ...
  lcd.print("T: ");
  lcd.setCursor(2, 1);  // col 0, ligne 0
  lcd.print(t);
  lcd.setCursor(8, 1);  // col 0, ligne 0
  lcd.print("V: ");
  lcd.setCursor(10, 1);  // col 0, ligne 0
  lcd.print(v);
  ...
  lcd.print("Taille: ");
  lcd.setCursor(8, 0);  // col 0, ligne 0
  lcd.print(distance);
  lcd.setCursor(14, 0);  // col 0, ligne 0
  lcd.print("cm");
}
